...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/16 13:54:00 by bpouchep          #+#    #+#             */
/*   Updated: 2022/09/16 13:54:02 by bpouchep         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	test.insert(ft::pair<std::string, std::string>("This is", "The End"));
	...
	int_string.insert(ft::pair<int, std::string>(42, "Hello World!"));
	string_string.insert(ft::pair<std::string, std::string>("uwu", "Hello World!"));
	...
	string_string.insert(ft::pair<std::string, std::string>("blabla", "coucou"));
	string_string.insert(ft::pair<std::string, std::string>("bonjour", "aurevoir"));
	string_string.insert(ft::pair<std::string, std::string>("Only", "Human"));
	string_string.insert(ft::pair<std::string, std::string>("After", "All"));
	string_string.insert(ft::pair<std::string, std::string>("Soulja", "Boy"));

	char_char.insert(ft::pair<char, char>('q', 'a'));
	char_bool.insert(ft::pair<char, bool>('w',false));
	char_char.insert(ft::pair<char, char>('e', 's'));
	char_bool.insert(ft::pair<char, bool>('r',true));
	char_char.insert(ft::pair<char, char>('t', 'd'));
	char_bool.insert(ft::pair<char, bool>('y',false));
	char_char.insert(ft::pair<char, char>('u', 'f'));
	char_bool.insert(ft::pair<char, bool>('i',true));
	...
	std::cout << "\n";
	ft::map<int, int>	map2;
	ft::map<int, int>::iterator	map2_ite;

	map2.insert(ft::pair<int, int>(42, 11238));
	map2.insert(ft::pair<int, int>(25, 88907));
	map2.insert(ft::pair<int, int>(125, 18));
	map2.insert(ft::pair<int, int>(16857, 132));
	map2.insert(ft::pair<int, int>(568, 18));
	map2.insert(ft::pair<int, int>(67568, 658));
	map2.insert(ft::pair<int, int>(5687, 5678));
	map2.insert(ft::pair<int, int>(64, 54754));
	map2.insert(ft::pair<int, int>(5623123, 56782));
	map2.insert(ft::pair<int, int>(213, 56754));
	map2.insert(ft::pair<int, int>(568, 5687));
